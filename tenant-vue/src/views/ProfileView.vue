...
<template>
  <section class="page profile-page">
    ...
    <section class="service-panel"><h2>身份资料</h2><div class="identity-summary"><p><b>姓名</b><span>{{ store.identity.realName || '未填写' }}</span></p><p><b>手机号</b><span>{{ store.identity.mobile || '未填写' }}</span></p><p><b>家庭住址</b><span>{{ store.identity.homeAddress || '选填' }}</span></p></div></section>
